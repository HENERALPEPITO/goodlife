...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'invoice_settings' AND column_name = 'contact_person') THEN
    ALTER TABLE invoice_settings ADD COLUMN contact_person TEXT;
  END IF;
END $$;
...
-- ============================================
-- 7. ADD payment_request_id TO INVOICES TABLE
-- ============================================
